# -*- coding: utf-8 -*-
"""
Created on Tue Dec 10 17:25:46 2024
...
class ModelAnalysis:
    ...
    def save_results_to_csv(self, results_df):
        results_df.to_csv("dbscan_combinations_results.csv", index=False)
...
st.sidebar.write("""
Este código realiza un análisis de **clustering** utilizando el modelo **DBSCAN** con diferentes combinaciones de atributos. A continuación, se describen los pasos y funcionalidades principales:

1. **Base de Datos:** Utiliza el conjunto de datos Iris.
2. **Modelo Utilizado:** DBSCAN.
...
st.title('Análisis de Modelo DBSCAN para Todas las Combinaciones')
...
st.write("### Resultados del Rendimiento del Modelo DBSCAN", styled_df)